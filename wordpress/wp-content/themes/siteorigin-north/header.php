		...
		<header id="masthead" class="site-header layout-<?php echo sanitize_html_class( str_replace('_', '-', siteorigin_setting( 'masthead_layout' ) ) ) ?><?php if( siteorigin_setting( 'navigation_sticky' ) ) echo 'sticky-menu'; ?>" role="banner"
			...
			<div class="container">
				<div id="extraHeaderInfo">
						<a href="http://www.wolfssl.jp/wolfsite/" target="_blank"><img src="http://test.wolfssl.com:8888/wordpress/wp-content/uploads/2017/07/JapanFlag.jpg" alt="wolfSSL Japan"></a>
						<div class="push"></div>
						<ul id="supportNav"><li>Questions? +1 (425) 245-8247</li>
							<li>+1(425)245-8247</li>
						<li><a href="http://wolfssl.com/forums">Support Forums</a></li></ul>
					</div>

...
.social-feed-container-<?php echo $id; ?> .entry-content img{
	margin: 0 !important;
}
...
<div id="tfba_loadin_div">
<img style="border-radius: 50%;
    width: 45px;" id="tfba_loading" src="<?php echo plugins_url('images/tw.gif',__FILE__); ?>" /><br/>
    Loading...
</div>
</div>
<script>
...
jQuery('#tfba_loadin_div').remove();}, 500);
</script>
